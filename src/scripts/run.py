...
class Run:
    ...
    def run(self):
        ...
        if self.start_epoch == 1:
            # for a new run, record the answer_classes, substitutions, as well as
            # the count of model parameters.
        ...
        try:
            for epoch in range(self.start_epoch, self.config.max_epochs+1):
                ...
                print("Training...")
                model_trainer.train_one_epoch(epoch, performance_tracker, no_progress_bar=self.no_progress_bar)
